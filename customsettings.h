tGameSetting aNewGameSettings[] = {
		...
		{ "Game", "PlayerListDefaultState", &nPlayerListDefaultState, 1, 0, 0 },
		...
		{ "Game", "PerTrackSoundtrack", &nPerTrackSoundtrack, 1, 0, 0 },
		...
		{ "Game", "AchievementProgression", &Achievements::nTotalProgression, 0, 0, 100 },
		...
		{ "Control", "MouseSensitivity", &nMouseSensitivity, 0, 0, 100 },
