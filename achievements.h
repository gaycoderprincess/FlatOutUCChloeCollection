namespace Achievements {
	...
	std::vector<CAchievement*> gAchievements = {
		...
		new CAchievement("TRACKMASTER_FOREST", "Forest Map Veteran", "Win a race on every Forest track", CAT_TRACKS),
		new CAchievement("TRACKMASTER_FIELDS", "Field Map Veteran", "Win a race on every Field track", CAT_TRACKS),
		new CAchievement("TRACKMASTER_DESERT", "Desert Map Veteran", "Win a race on every Field track", CAT_TRACKS),
		new CAchievement("TRACKMASTER_CANAL", "Canal Map Veteran", "Win a race on every Canal track", CAT_TRACKS),
		new CAchievement("TRACKMASTER_CITY", "City Map Veteran", "Win a race on every City track", CAT_TRACKS),
		new CAchievement("TRACKMASTER_RACE", "Race Map Veteran", "Win a race on every Race track", CAT_TRACKS),
		new CAchievement("TRACKMASTER_TOWN", "Town Map Veteran", "Win a race on every Town track", CAT_TRACKS),
		new CAchievement("TRACKMASTER_PIT", "Pit Map Veteran", "Win a race on every Pit track", CAT_TRACKS),
		new CAchievement("TRACKMASTER_WINTER", "Winter Map Veteran", "Win a race on every Winter track", CAT_TRACKS),
		new CAchievement("TRACKMASTER_TT", "Stadium Map Veteran", "Win a race on every Tough Trucks track", CAT_TRACKS, true),
		new CAchievement("TRACKMASTER_RT", "Rally Map Veteran", "Win a race on every Rally Trophy track", CAT_TRACKS),
		new CAchievement("TRACKMASTER_EVENT", "Event Map Veteran", "Win a race on every Event track", CAT_TRACKS),
		new CAchievement("TRACKMASTER_DERBY", "Derby Map Veteran", "Win a derby on every Derby track", CAT_TRACKS),
	};
